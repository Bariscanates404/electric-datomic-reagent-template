...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_29651 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_29651(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29656 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29656(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29663 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29663(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29666 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29666(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29669 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29669(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29673 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29673(reader);
}
});
...
var G__29773 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__29774 = s.append(c);
c = G__29773;
s = G__29774;
continue;
}
