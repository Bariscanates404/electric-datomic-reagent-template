...
(missionary.impl.Dataflow.Port.prototype.call = (function (unused__14959__auto__){
var self__ = this;
var self__ = this;
var G__29398 = (arguments.length - (1));
switch (G__29398) {
case (1):
...
(missionary.impl.Dataflow.Port.prototype.apply = (function (self__,args29397){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29397)));
}));
...
var _BANG_ = (function (p1__29391_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__29391_SHARP_) : s_BANG_.call(null,p1__29391_SHARP_));
});
...
var G__29418 = (new missionary.Cancelled("Dataflow variable dereference cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__29418) : f_BANG_.call(null,G__29418));
} else {
return null;
}
}
