...
(missionary.impl.Mailbox.Port.prototype.call = (function (unused__14959__auto__){
var self__ = this;
var self__ = this;
var G__29389 = (arguments.length - (1));
switch (G__29389) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args29387){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29387)));
}));
...
var vec__29399 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29399,(0),null);
...
var _BANG_ = (function (p1__29381_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__29381_SHARP_) : s_BANG_.call(null,p1__29381_SHARP_));
});
...
var G__29414 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__29414) : f_BANG_.call(null,G__29414));
} else {
return null;
}
});
...
var G__29415_29451 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__29415_29451) : s_BANG_.call(null,G__29415_29451));

return missionary.impl.Mailbox.nop;
}
} else {
var G__29417_29452 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__29417_29452) : s_BANG_.call(null,G__29417_29452));
