...
(missionary.impl.Never.Process.prototype.call = (function (unused__14959__auto__){
var self__ = this;
var self__ = this;
var G__29375 = (arguments.length - (1));
switch (G__29375) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args29367){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29367)));
}));
...
var G__29406 = (new missionary.Cancelled("Never cancelled."));
var fexpr__29405 = ps.f;
