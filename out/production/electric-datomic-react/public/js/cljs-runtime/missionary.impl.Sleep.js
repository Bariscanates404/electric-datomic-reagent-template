...
(missionary.impl.Sleep.Process.prototype.call = (function (unused__14959__auto__){
var self__ = this;
var self__ = this;
var G__29371 = (arguments.length - (1));
switch (G__29371) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args29363){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29363)));
}));
...
var G__29404 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__29403 = s.failure;
return (fexpr__29403.cljs$core$IFn$_invoke$arity$1 ? fexpr__29403.cljs$core$IFn$_invoke$arity$1(G__29404) : fexpr__29403.call(null,G__29404));
} else {
return null;
}
});
