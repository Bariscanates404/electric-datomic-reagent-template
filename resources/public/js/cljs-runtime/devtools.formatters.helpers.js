...
var G__29418 = devtools.prefs.pref(v);
v = G__29418;
continue;
} else {
return v;
...
}catch (e29373){var _e__28232__auto__ = e29373;
return false;
}})();
...
}catch (e29375){var _e__28232__auto__ = e29375;
return false;
}})();
...
}catch (e29377){var _e__28232__auto__ = e29377;
return false;
}}
}
});
...
var vec__29397 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29397,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29397,(1),null);
...
return cljs.core.some((function (p1__29406_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29406_SHARP_);
}),template);
});
