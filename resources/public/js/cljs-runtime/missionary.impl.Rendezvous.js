...
(missionary.impl.Rendezvous.Port.prototype.call = (function (unused__14959__auto__){
var self__ = this;
var self__ = this;
var G__28768 = (arguments.length - (1));
switch (G__28768) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args28765){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args28765)));
}));
...
var G__28788 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__28788) : f_BANG_.call(null,G__28788));
} else {
return null;
}
});
} else {
var vec__28795 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28795,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__28761_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__28761_SHARP_) : s_BANG_.call(null,p1__28761_SHARP_));
});
...
var G__28817 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__28817) : f_BANG_.call(null,G__28817));
} else {
return null;
}
});
} else {
var vec__28825 = temp__5806__auto__;
var vec__28828 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28825,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28828,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28828,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
