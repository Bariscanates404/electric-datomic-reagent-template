...
(missionary.impl.Semaphore.Port.prototype.call = (function (unused__14959__auto__){
var self__ = this;
var self__ = this;
var G__29386 = (arguments.length - (1));
switch (G__29386) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args29382){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29382)));
}));
...
var vec__29407 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29407,(0),null);
...
var G__29419 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__29419) : f_BANG_.call(null,G__29419));
} else {
return null;
}
});
