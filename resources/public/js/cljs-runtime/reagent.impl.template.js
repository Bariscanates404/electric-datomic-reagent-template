...
var G__33267 = o;
reagent.impl.template.goog$module$goog$object.set(G__33267,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__33285__delegate = function (args){
...
return G__33285__delegate.call(this,args);};
...
return G__33285__delegate(args);
});
...
var G__33268 = o;
reagent.impl.template.goog$module$goog$object.set(G__33268,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__33288__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__33289__i < G__33289__a.length) {G__33289__a[G__33289__i] = arguments[G__33289__i + 0]; ++G__33289__i;}
  args = new cljs.core.IndexedSeq(G__33289__a,0,null);
} 
...
var args = cljs.core.seq(arglist__33290);
...
var G__33269 = props;
var G__33269__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33269,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__33269);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33269__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__33270 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33270,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__33270;
}
})(),id_class);
...
var G__33271 = (cljs.core.count(argv) - first_child);
switch (G__33271) {
case (0):
...
var vec__33272 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33272,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33272,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33272,(2),null);
...
var temp__5808__auto___33306 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___33306 == null)){
} else {
var key_33307 = temp__5808__auto___33306;
(jsprops.key = key_33307);
}
...
var temp__5808__auto___33311 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___33311 == null)){
} else {
var key_33312 = temp__5808__auto___33311;
...
var temp__5808__auto___33317 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___33317 == null)){
} else {
var key_33318 = temp__5808__auto___33317;
(jsprops.key = key_33318);
}
...
var temp__5808__auto___33327 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___33327 == null)){
} else {
var key_33328 = temp__5808__auto___33327;
(jsprops.key = key_33328);
}
...
var temp__5808__auto___33329 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___33329 == null)){
} else {
var key_33332 = temp__5808__auto___33329;
(jsprops.key = key_33332);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33275_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__33275_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__33276 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33276,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33276,(1),null);
...
break;
default:
var G__33345 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__33346 = compiler;
v = G__33345;
compiler = G__33346;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template33282 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template33282 = (function (opts,id,fn_to_element,parse_fn,meta33283){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template33282.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33284,meta33283__$1){
var self__ = this;
var _33284__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template33282(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta33283__$1));
}));

(reagent.impl.template.t_reagent$impl$template33282.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33284){
var self__ = this;
var _33284__$1 = this;
return self__.meta33283;
}));

(reagent.impl.template.t_reagent$impl$template33282.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template33282.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template33282.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template33282.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template33282.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template33282.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta33283","meta33283",1319032549,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template33282.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template33282.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template33282");

(reagent.impl.template.t_reagent$impl$template33282.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template33282");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template33282.
 */
reagent.impl.template.__GT_t_reagent$impl$template33282 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template33282(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta33283){
return (new reagent.impl.template.t_reagent$impl$template33282(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta33283));
});

}

return (new reagent.impl.template.t_reagent$impl$template33282(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
